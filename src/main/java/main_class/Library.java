...
public class Library {
   ...
   */
  public void addDocument(String title, String author, int copiesAvailable, String description,
      String image) {
    Document doc = new Document(title, author, copiesAvailable, description, image);
  ...
  public boolean checkPosition(String id) {
    return dbManager.checkPosition(id);
  }
